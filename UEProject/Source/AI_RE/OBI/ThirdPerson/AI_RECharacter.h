...
class UPlayerSurvivalComponent;
...
protected:
	...
	// 생존 컴포넌트 (체력, 스태미나, 배고픔 등)
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Player Components")
	TObjectPtr<UPlayerSurvivalComponent> SurvivalComponent;
	// 인벤토리 컴포넌트
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Player Components")
...
public:
	...
	FORCEINLINE TObjectPtr<UPlayerSurvivalComponent> GetSurvivalComponent() const { return SurvivalComponent; }
